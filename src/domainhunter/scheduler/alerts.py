...
from domainhunter.domain.candidates import CandidateOutcome
...
from domainhunter.scheduler.runbooks import get_runbook
from domainhunter.storage.sqlite import SQLiteStore


_LOGGER = logging.getLogger("domainhunter.scheduler.alerts")
